...
/**
 * Use to test pre-lab 3, problem 1
 *
...
public class Problem1 {
	...
	public static void main(String[] args) {				
		...
		inputString = JOptionPane.showInputDialog("Problem 1\n\n" +
		...
		if (controlStructure.isNumeric(inputString)){
			...
			if (controlStructure.isNumeric(inputString)){
				...
				answer = controlStructure.preLab1(variable1, variable2);
				JOptionPane.showMessageDialog(null,"Problem 1\n\n" +
						"IF variable1 < variable2 THEN\n" +
						"     PRINT \"true\"\n" + 
						"ELSE\n" +
						"     PRINT \"false\"\n" +
