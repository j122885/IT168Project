...
public class Employee
{
	 ...
	 *            The hourly pay rate of the employee
	 * @param ytdGross
	 *            The gross pay year to date for the employee
	 */
	 ...
	 * 
	 * @param percentRaise
	 *            The percentage by which the hourly rate is to increase: 5 is
	 *            5%
	 */
	...
	/**
	 * Calculates the employee's weekly pay, updates the grossPayYTD, and
	 * returns the pay for the week. Pay does take overtime into account.
	 * 
	 * @param hoursWorked
	...
	public void print()
	{
		...
		System.out
				.println("Gross pay year to date: " + fmt.format(grossPayYTD));
	}
}
